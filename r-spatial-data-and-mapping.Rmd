...
Welcome to spatial Data and Mapping in R!
In this talk, we will focus on building maps using `ggplot2`, one of R's most popular libraries for data visualization. If you're already familiar with creating graphs using `ggplot`, you'll find making maps a natural extension of those skills.
...
The geometry of a raster defines the spatial location of its pixels and can be described by the following components:
| Parameter       | Purpose                                          |
|-----------------|--------------------------------------------------|
...
![Map of Switzerland using ggplot2](C:/RIT/RMaps/r-spatial-data-and-mapping/images/crazy_swiss_map_with_crazy_legend.png)
